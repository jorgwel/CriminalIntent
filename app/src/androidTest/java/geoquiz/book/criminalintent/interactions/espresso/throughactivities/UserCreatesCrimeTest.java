package geoquiz.book.criminalintent.interactions.espresso.throughactivities;
...
//        getActivity();
    ...
    private class UtilMethods {
        ...
        void verifyNumberOfItemsInListOfCrimes(int numberOfItemsToValidate) {
            ...
            geoquiz.book.criminalintent.interactions.espresso.local.CrimeListActivityTest.assertEquals(
